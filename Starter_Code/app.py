...
def welcome():
    ...
    return (
        ...
        f"-- Precipitation last 12 months: <a href=\"/api/v1.0/precipitation\">/api/v1.0/precipitation<a><br/>"
        f"-- List of Stations: <a href=\"/api/v1.0/stations\">/api/v1.0/stations<a><br/>"
        f"-- Temperature observations for the previous year for most active station.: <a href=\"/api/v1.0/tobs\">/api/v1.0/tobs<a><br/>"
        f"-- Min, Average & Max Temperatures for specified start date.: <a href=\"/api/v1.0/trip/start_date\">/api/v1.0/start<a><br/>"
        f"-- Min, Average & Max Temperatures for date range.: <a href=\"/api/v1.0/trip/start_date/end_date\">/api/v1.0/start_date/end_date<a><br/>"
...
def trip1(start_date = '2016-08-23'):
    # Calculate minimum, average and maximum temperatures for dates starting with start date.
...
def trip2(start_date = '2016-08-23', end_date='2017-08-23'):
